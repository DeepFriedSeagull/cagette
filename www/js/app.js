...
var ProductType = $hxClasses["ProductType"] = { __ename__ : ["ProductType"], __constructs__ : ["CTVegetable","CTCheese","CTChicken","CTFruit","CTBread","CTMilk","CTEggs","CTHoney","CTKiwi","CTJuice","CTApple"] };
...
ProductType.CTFruit = ["CTFruit",3];
ProductType.CTFruit.toString = $estr;
ProductType.CTFruit.__enum__ = ProductType;
ProductType.CTBread = ["CTBread",4];
ProductType.CTBread.toString = $estr;
ProductType.CTBread.__enum__ = ProductType;
ProductType.CTMilk = ["CTMilk",5];
ProductType.CTMilk.toString = $estr;
ProductType.CTMilk.__enum__ = ProductType;
...
ProductType.CTKiwi = ["CTKiwi",8];
ProductType.CTKiwi.toString = $estr;
ProductType.CTKiwi.__enum__ = ProductType;
...
ProductType.__empty_constructs__ = [ProductType.CTVegetable,ProductType.CTCheese,ProductType.CTChicken,ProductType.CTFruit,ProductType.CTBread,ProductType.CTMilk,ProductType.CTEggs,ProductType.CTHoney,ProductType.CTKiwi,ProductType.CTJuice,ProductType.CTApple];
